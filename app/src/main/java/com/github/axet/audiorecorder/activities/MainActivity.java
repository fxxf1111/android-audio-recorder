...
public class MainActivity extends AppCompatThemeActivity {
    ...
    String[] permission = {Manifest.permission.READ_PHONE_STATE, Manifest.permission.WRITE_EXTERNAL_STORAGE,
...
//            Toast.makeText(MainActivity.this, "必须授予所有权限！", Toast.LENGTH_LONG).show();
            String[] permissions = mPermissionList.toArray(new String[mPermissionList.size()]);
            ActivityCompat.requestPermissions(MainActivity.this, permissions, 1);
//            ErrorDialog.Error(MainActivity.this, "必须授予所有权限！");
        } else {
            try {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == 1) {
            ...
            if (!hasAllPermision){
                ErrorDialog.Error(MainActivity.this, "缺少必要权限\n你选择了禁止后不再询问，请主动授予 。");
